...
//   // useEffect(() => {
//   //   const Watchlisted = watchlistdb.map((watchlist) => watchlist.id);

//   //   // Create a copy of the current state and update only the necessary indexes

//   //   if (!Array.isArray(isAdded)) {
//   //     setIsAdded(new Array(medias.length).fill(false));
//   //     return;
//   //   }
//   //   const updatedIsAdded = [...isAdded];

//   //   Watchlisted.forEach((itemId) => {
//   //     const index = medias.findIndex((media) => media.id === itemId);
//   //     if (index !== -1) {
...
//                           isAdded[index] ? "bg-white/90 text-black" : ""
//                         }`}
//                       >
//                         Watchlist
//                         {isAdded[index] ? (
