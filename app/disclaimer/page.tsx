    ...
    <div>
      ...
      <ul>
        <li>
          ...
          this Disclaimer) refers to Movies.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Movies, accessible from{" "}
          <a
            href="https://www.movies.com"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://www.movies.com
          </a>
        </li>
      </ul>
      <h2>Disclaimer</h2>
      ...
      <ul>
        <li>By email: mikelemigliore@hotmail.com</li>
      </ul>
    </div>
  );
}
