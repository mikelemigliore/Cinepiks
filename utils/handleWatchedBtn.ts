...
import { likeMovie, unlikeMovie, unwatchedMovie, unwatchlistMovie, watchedMovie, watchlistMovie } from "@/app/features/dbSlice";
import { getWatchlist } from "@/app/pages/api/watchlistPage";
import { getWatched } from "@/app/pages/api/watchedPage";

//const dispatch = useDispatch();

async function handleWatchedBtn(dispatch:any, setIsAdded: any, isAdded: boolean, id: number, mediaType:string) {
